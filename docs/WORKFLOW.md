...
5. Update src/contracts.ts when changing current report shapes; the archived Python schema documents v1. Distinguish null raw data from imputed values. Keep stable feature ordering and units.
...
Recommended next coherent commit after review: `refactor: move rowing analysis into browser and configure static Netlify deployment`.
